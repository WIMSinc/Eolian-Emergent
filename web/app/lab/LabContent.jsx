    ...
    <div data-testid="lab-page">
      ...
      <section className="relative pt-32 pb-20 md:pt-40 md:pb-28">
        ...
        <div className="relative max-w-[1400px] mx-auto px-6 md:px-12">
          <div className="flex items-center gap-3 mb-4">
            ...
            <span className="font-mono text-xs tracking-[0.2em] text-zinc-400 uppercase">R&D // Experiments</span>
          </div>
          ...
          <Link href="/artak" data-testid="lab-artak-link" className="inline-flex items-center gap-2 mt-6 font-mono text-xs tracking-[0.2em] text-zinc-500 hover:text-white transition-colors uppercase">
      ...
      <section className="py-20 md:py-28 border-t border-zinc-800">
        <div className="max-w-[1400px] mx-auto px-6 md:px-12">
          <div className="mb-12">
            <span className="font-mono text-xs tracking-[0.2em] text-zinc-400 uppercase block mb-4">White Papers // Results</span>
