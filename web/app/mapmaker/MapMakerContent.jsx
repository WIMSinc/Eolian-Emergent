...
export default function MapMakerContent() {
  return (
        ...
        <div className="max-w-[1400px] mx-auto px-6 md:px-12 text-center">
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp} custom={0}>
            ...
            <div className="flex gap-4 justify-center flex-wrap">
              <Link href="/#contact" className="inline-flex items-center gap-2 bg-[#D90412] text-white font-mono uppercase text-xs tracking-widest px-8 py-4 hover:bg-[#FF0B1B] transition-colors">
