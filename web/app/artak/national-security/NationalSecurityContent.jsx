...
export default function NationalSecurityContent() {
      ...
      <section className="relative pt-32 pb-20 md:pt-40 md:pb-28">
        ...
        <div className="relative max-w-[1400px] mx-auto px-6 md:px-12">
          <div className="flex items-center gap-4 mb-4">
            <img src="/artak-logo-white.webp" alt="ARTAK" width="200" height="74" className="h-10 w-auto opacity-90" />
            <span className="font-mono text-xs tracking-[0.2em] text-zinc-400 uppercase">ARTAK // Use Cases</span>
          </div>
          ...
          <button
            ...
            className="mt-6 inline-flex items-center gap-2 bg-[#D90412] text-white font-mono uppercase text-sm tracking-widest px-8 py-4 hover:bg-[#FF0B1B] transition-colors"
          >
