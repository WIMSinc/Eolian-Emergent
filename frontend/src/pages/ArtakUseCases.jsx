    ...
    <div data-testid="artak-usecases-page">
      ...
      <section className="relative pt-32 pb-20 md:pt-40 md:pb-28">
        ...
        <div className="relative max-w-[1400px] mx-auto px-6 md:px-12">
          ...
          <button onClick={() => setCatalogOpen(true)} data-testid="download-catalog-btn" className="mt-6 inline-flex items-center gap-2 bg-[#FF0B1B] text-white font-mono uppercase text-sm tracking-widest px-8 py-4 hover:bg-[#D90412] transition-colors">
      ...
      <section className="py-16 md:py-20 border-t border-zinc-800">
        <div className="max-w-[1400px] mx-auto px-6 md:px-12">
          ...
          <div className="border border-zinc-800 overflow-hidden group">
            <img src="/artak-dhs-ov1.png" alt="DHS ARTAK Operational View" className="w-full h-auto transition-transform duration-700 group-hover:scale-[1.02]" loading="lazy" />
          </div>
      ...
      <section className="py-20 md:py-28 border-t border-zinc-800">
        <div className="max-w-[1400px] mx-auto px-6 md:px-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-px bg-zinc-800">
            {useCases.map((uc, i) => (
              <motion.div key={i} custom={i} initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-50px" }} variants={fadeUp} data-testid={`usecase-card-${i}`} className="bg-[#0A0A0A] group relative overflow-hidden">
