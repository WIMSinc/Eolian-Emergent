...
const assessments = [
  ...
  },
  {
    ...
    location: "Australia",
    period: "2022",
    desc: "EolianVR was selected as a nominee for Project Convergence 2022 — the U.S. Army's premier campaign of learning focused on multi-domain operations and integration of emerging technologies. Selection reflects ARTAK's recognition as a technology with potential application across the joint force's modernization agenda in mission command, distributed C2, and 3D battlespace awareness.",
  ...
  {
    featured: false,
    category: "XX — Confirm Organizing Body",
    title: "T-REX (Tactical Response Exercise)",
    unit: "XX",
    location: "XX",
    period: "XX",
    desc: "ARTAK participated in T-REX, validating its performance across tactical response operations. Full entry pending confirmation of unit, location, year, and key outcomes.",
    outcome: "XX",
  },
  {
    featured: false,
    ...
    location: "XX",
    period: "XX",
    desc: "EolianVR participated in the AIC Tech ID (AI/Autonomy Integration Capability — Technology Identification) process as part of an effort to identify emerging mixed reality and C2 technologies for potential integration. Full entry pending confirmation of organizing command, year, and outcomes.",
    outcome: "XX",
  },
  {
    featured: false,
    category: "USSOCOM — Confirm Role",
    title: "TALOS Program",
    unit: "U.S. Special Operations Command",
    location: "XX",
    period: "XX",
    desc: "EolianVR engaged with the TALOS (Tactical Assault Light Operator Suit) program, demonstrating ARTAK's potential as a C2 and situational awareness layer within the broader integrated operator capability suite. Full entry pending confirmation of specific role and whether publicly referenceable.",
    outcome: "XX",
  },
  {
    featured: false,
