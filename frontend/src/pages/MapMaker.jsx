...
export default function MapMaker() {
  return (
    <div data-testid="mapmaker-page">
      <SEO
        title="Map Maker - 3D Mapping Software"
        description="Map Maker creates high-quality 3D maps in minutes from images, video, or LiDAR. Entirely automated, works offline, interoperable with ARTAK and ATAK."
        path="/mapmaker"
      />
      {/* Hero */}
