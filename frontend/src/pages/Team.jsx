      ...
      <section className="relative pt-32 pb-20 md:pt-40 md:pb-28">
        ...
        <div className="relative max-w-[1400px] mx-auto px-6 md:px-12">
          <div className="flex items-center gap-3 mb-4">
            ...
            <span className="font-mono text-xs tracking-[0.2em] text-zinc-400 uppercase">People // Team</span>
          </div>
      ...
      <section className="py-20 md:py-28 border-t border-zinc-800">
        <div className="max-w-[1400px] mx-auto px-6 md:px-12">
          <div className="mb-12">
            <div className="flex items-center gap-3 mb-4">
              <div className="w-8 h-px bg-[#FF0B1B]" />
              <span className="font-mono text-xs tracking-[0.2em] text-zinc-400 uppercase">Executive // Leadership</span>
            </div>
