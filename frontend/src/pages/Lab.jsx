...
export default function Lab() {
  return (
    <div data-testid="lab-page">
      <SEO
        title="The Eolian Lab"
        description="Rigorous experiments testing ARTAK's impact on mission planning, intelligence briefings, real-time UAS tracking, and multi-site collaboration."
        path="/lab"
      />
      {/* Hero */}
