...
export const organizationSchema = {
  ...
  "@type": "Organization",
  name: "EolianVR, Inc.",
  alternateName: "Eolian",
  url: SITE_URL,
  logo: `${SITE_URL}/eolian-logo-white.png`,
  description: "EolianVR develops Augmented Reality, Virtual Reality, Mixed Reality, AI/ML, and 3D Animation solutions for enterprise and government/public sector entities.",
  foundingDate: "2017",
...
export function articleSchema({ title, description, image, slug, published }) {
  return {
    ...
    publisher: {
      ...
      logo: {
        "@type": "ImageObject",
        url: `${SITE_URL}/eolian-logo-white.png`,
      },
    },
    mainEntityOfPage: {
      "@type": "WebPage",
