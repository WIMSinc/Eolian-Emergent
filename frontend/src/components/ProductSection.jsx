...
const panels = [
  ...
  {
    sysLabel: "[SYS.04]",
    title: "XR Ship Design Virtual Environment",
    subtitle: "Immersive Collaborative Design Review",
    description:
      "Engineers, designers, and stakeholders collaborate in a shared 3D environment to validate ship systems, resolve issues, and drive better decisions — earlier. Cross-platform access across XR headsets, tablets, and desktops with real-time synchronization.",
    image: "/artak-xr-sdve.jpg",
    icon: Shield,
    span: "md:col-span-6",
  },
      ...
      <div className="max-w-[1400px] mx-auto px-6 md:px-12">
        ...
        <div className="mb-16">
          <div className="flex items-center gap-4 mb-4">
            <img src="/artak-logo-white.png" alt="ARTAK" className="h-8 w-auto opacity-90" />
